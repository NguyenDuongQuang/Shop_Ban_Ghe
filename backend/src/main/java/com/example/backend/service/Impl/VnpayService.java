...
public class VnpayService {
    public ResponseEntity<VNPayDto> createPayment(HoaDonDTO hoaDonDTO){
        ...
        vnp_Params.put("vnp_ReturnUrl", VNPayConfig.get_Return_url(hoaDonDTO.getTongTienDonHang(), String.valueOf(hoaDonDTO.getId())));
    ...
    public ResponseEntity<VNPayDto> createPaymentMuaNgay(HoaDonDTO hoaDonDTO){
        ...
        vnp_Params.put("vnp_ReturnUrl", VNPayConfig.get_Return_urlMuaNgay(hoaDonDTO.getTongTienDonHang(), String.valueOf(hoaDonDTO.getId())));
        vnp_Params.put("vnp_IpAddr", vnp_IpAddr);
